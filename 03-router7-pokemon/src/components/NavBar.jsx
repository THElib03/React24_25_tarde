    ...
    return <nav className=" bg-gradient-to-tr from-rose-500 to-pink-500">
        <div className=" container mx-auto flex justify-between items-center p-4">
            ...
            */}
            ...
            <NavLink to={ROUTES.SEARCH} className=" text-white hover:text-red-600 text-2xl font-bold">Search</NavLink>
            <NavLink to={ROUTES.FAVORITES} className=" text-white hover:text-red-600 text-2xl font-bold">Favorites</NavLink>
        </div>
    </nav>;
};
